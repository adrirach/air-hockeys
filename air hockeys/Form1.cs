...
namespace air_hockeys
{
    public partial class Form1 : Form
    {
        ...
        Font screenFont = new Font("Consolas", 15);
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void gametimer_Tick(object sender, EventArgs e)
        {
            ...
            Rectangle bottom = new Rectangle(bottomx, bottomy, bottomwidth, bottomlenth);
            Rectangle side1 = new Rectangle(side1x, side1y, side1width, side1lenth);
            Rectangle side2 = new Rectangle(side2x, side2y, side2width, side2lenth);
            Rectangle side3 = new Rectangle(side3x, side3y, side3width, side3lenth);
            Rectangle side4 = new Rectangle(side4x, side4y, side4width, side4lenth);
        ...
        private void form1_paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.FillRectangle(blueBrush, bottomx, bottomy, bottomwidth, bottomlenth);
            e.Graphics.FillRectangle(blueBrush, side1x, side1y, side1width, side1lenth);
            e.Graphics.FillRectangle(blueBrush, side2x, side2y, side2width, side2lenth);
            e.Graphics.FillRectangle(blueBrush, side3x, side3y, side3width, side3lenth);
            e.Graphics.FillRectangle(blueBrush, side4x, side4y, side4width, side4lenth);
